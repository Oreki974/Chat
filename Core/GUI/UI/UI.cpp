...
namespace Chat::UI {
	...
	void DrawButtonImage(const std::shared_ptr<Chat::Image>& imageNormal, const std::shared_ptr<Chat::Image>& imageHovered, const std::shared_ptr<Chat::Image>& imagePressed,
	...
	void DrawButtonImage(const std::shared_ptr<Chat::Image>& image,
		ImU32 tintNormal, ImU32 tintHovered, ImU32 tintPressed,
		ImVec2 rectMin, ImVec2 rectMax)
	{
